...
(function() {
    ...
    function Carousel(element) {
        ...
        function locationUpdates() {
            ...
            var url =  indexName[current_carousel] + '-' + pageNames[current_carousel][current_pane[current_carousel]];
            var t = (pageTitles[current_carousel][current_pane[current_carousel]] || '');
            if(t){
                t = ' - ' + t;
            }
            var pageTitle = "Zubair:" + indexName[current_carousel].toTitleCase() +  t
        ...
        function setContainerOffset(percent, animate) {
            ...
            if (Modernizr.csstransforms && !iOS && !isMSIE) {
        ...
        function handleHammer(ev) {
            ...
            switch (ev.type) {
                ...
                case 'dragdown':
                    ...
                    locky = true;
                    var drag_offset = -((current_carousel) * carousels_height) + (ev.gesture.deltaY);
                ...
                case 'dragleft':
                    ...
                    var drag_offset = -((current_pane[current_carousel]) * width) + (ev.gesture.deltaX);
                ...
                case 'release':
                    ...
                    if (locky) {
                        ...
                        if (Math.abs(ev.gesture.deltaY) > carousels_height / 10) {
        ...
        }).on("tap dragup dragdown dragleft dragright swipeleft swiperight swipeup swipedown release ", handleHammer);
    ...
    $(".link").click(function(ev) {
        ...
        var page = $(ev.currentTarget).data('link').split('/')
    ...
    for (var i = 0; i < carousels_count; i++) {
        ...
        var titles = $(carousels[i]).find("li").map(function() {
            //console.log(this)
    ...
    $('.customButton').click(function(e) {
        var token = function(res) {
            ...
            $.post(MAIN_URL + "/photos/order", orderData).done(
                function(data) {
